...
function launchBuilder(){
  ...
  pBuild.appendChild(restoreBanner);pBuild.appendChild(eDiv);pBuild.appendChild(aeBtn);
  ...
  function mkEntry(data){
    ...
    function autoGrow(){descTA.style.height='auto';var h=Math.max(descTA._minH||70,descTA.scrollHeight);descTA.style.height=h+'px';descHlWrap.style.height=h+'px';}
    ...
    descTab.addEventListener('mousedown',function(e){
      ...
      function mv(e){var h=Math.max(70,sh+(e.clientY-sy));descTA._minH=h;descTA.style.height=h+'px';descHlWrap.style.height=h+'px';}
